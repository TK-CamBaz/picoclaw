...
func (al *AgentLoop) runAgentLoop(
	...
	// Annotate user message with media file paths so the LLM can reference
	// them in tool calls (e.g. save_note.py --media /path/to/image.jpg).
